...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary d-flex p-1">
  <div class="container-fluid02">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php   } else {  ?>
          class="nav-link"
        <?php } ?>  href="/citas/index.php">Axenda</a>
        </li>
        <li class="nav-item">
        ...
        <?php   } else {  ?>
          class="nav-link"
        <?php } ?> href="/persoas/index.php">Persoas</a>
        </li>
        <li class="nav-item">
        ...
        <?php   } else {  ?>
          class="nav-link"
        <?php } ?> href="/empresas/index.php">Empresas</a>
        </li>
        <li class="nav-item">
          <a <?php if($_SERVER['SCRIPT_NAME']=="/ofertas/index.php") { ?>
          class="nav-link active" aria-current="true"
        <?php   } else {  ?>
          class="nav-link"
        <?php } ?> href="/ofertas/index.php">Ofertas</a>
        </li>
        <li class="nav-item">
          <a <?php if($_SERVER['SCRIPT_NAME']=="/informes/index.php") { ?>
          class="nav-link active" aria-current="true"
        <?php   } else {  ?>
          class="nav-link"
        <?php } ?> href="/informes/index.php">Informes</a>
        </li>
      <li class="nav-item">
